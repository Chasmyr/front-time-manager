    ...
    <div class="wrapper sm:w-11/12 md:w-10/12 lg:w-9/12 xl:w-8/12 ">
        ...
        <div class="flex justify-center text-slate-950">
            <div class="w-full bg-secondary rounded-3xl md:mt-8 sm:max-w-md xl:p-0">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8" tabindex="0" aria-label="Sign in to your account">
                    ...
                    <form class="space-y-4 md:space-y-6" action="#">
                        <div>
                            ...
                            <input v-model="email" type="email" name="email" id="email" class="bg-tertiary text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="name@company.com" required="" aria-label="enter your email">
                        </div>
                        <div>
                            <label for="password" class="block mb-2 text-sm font-medium text-second-text">Password</label>
                            <input v-model="password" type="password" name="password" id="password" placeholder="••••••••" class="bg-tertiary text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required="" aria-label="enter your password">
                        </div>
